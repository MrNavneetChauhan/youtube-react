...
import { COMMENT_GET_FAILURE, COMMENT_GET_REQUEST, COMMENT_GET_SUCCESS, COMMENT_POST_FAILURE, COMMENT_POST_REQUEST, COMMENT_POST_SUCCESS } from "./actionTypes"
...
export const posttingComment = (toast,payload)=>(dispatch)=>{
    try{
        ...
        axios.post("https://youtube-by-navneet-server.herokuapp.com/comments",payload).then((res)=>{
        ...
        notification(toast,"Please try again later","Please check your internet connection","error")
    }
}
...
export const gettingComments = ()=>(dispatch)=>{
    try{
        ...
        axios.get(`https://youtube-by-navneet-server.herokuapp.com/comments?videoId=${video_id}`).then(({data})=>{
